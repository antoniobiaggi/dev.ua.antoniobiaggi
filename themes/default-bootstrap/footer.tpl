...
<contact@prestashop.com>
    * @copyright 2007-2016 PrestaShop SA * @license http://opensource.org/licenses/afl-3.0.php Academic Free License (AFL 3.0) * International Registered Trademark & Property of PrestaShop SA *} {if !isset($content_only) || !$content_only}
    </div>
    <!-- #center_column -->
...
{if $page_name == 'category'}
			 ...
			 <div class="catalog-toTop">
						<a href="#header"><div class="catalog-arrowWrap"></div>
						    <div class="catalog-topTitle">{l s='go to top'}</div></a>
					</div>
    ...
    <div class="block-info">
        <div class="block-info-wrapp">
            <div class="block-info-left">
                {include file="./modules/blocknewsletter/blocknewsletter.tpl"}
            </div>
    ...
    <div id="footer">
        <div class="content-footer">
            ...
            <div class="footer-content-wrapp right-futer-content">
                {$HOOK_FOOTER}
            </div>
        </div>
    </div>
    {/if} {/if} {include file="$tpl_dir./global.tpl"}
    </body>
