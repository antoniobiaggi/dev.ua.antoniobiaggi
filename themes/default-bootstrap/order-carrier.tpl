...
-->
						...
						<div class="hook_extracarrier" id="HOOK_EXTRACARRIER_{$id_address}">
							{if isset($HOOK_EXTRACARRIER_ADDR) &&  isset($HOOK_EXTRACARRIER_ADDR.$id_address)}{$HOOK_EXTRACARRIER_ADDR.$id_address}{else}{$HOOK_EXTRACARRIER_ADDR[2]}{/if}
						</div>
						{foreachelse}
...
<div class="s_text">{l s="Shipping cost will be determined by Мiст Експрес"}</div>
{strip}
{if !$opc}
