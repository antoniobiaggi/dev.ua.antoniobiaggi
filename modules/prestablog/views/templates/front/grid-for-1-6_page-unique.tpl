...
{if isset($news)}
    {if $prestablog_config.prestablog_socials_actif}
        <div class="ab-news-share">
            ...
            <li>
                <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={$prestablog_current_url|escape:'url':'UTF-8'}" class="social-icon-fb">
                    <img src="/themes/default-bootstrap/images/n_pages/icon3.png">
                </a>
            </li>
            {/if}
            {if $prestablog_config.prestablog_s_twitter}
            <li>
                <a href="https://twitter.com/share?url={$news->title|escape:'url':'UTF-8'}%20{$prestablog_current_url|escape:'url':'UTF-8'}" class="social-icon-tw"> <img src="/themes/default-bootstrap/images/n_pages/icon2.png">
                </a>
            </li>
            {/if}
    ...
    <p class="data-time"><img src="/themes/default-bootstrap/images/n_pages/icon_clock.png" alt="icon_clock.png">{dateFormat date=$news->date full=1}</p>
