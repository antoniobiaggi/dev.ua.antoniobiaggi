...
class StEasyContentClass extends ObjectModel
{
	...
	{
		return  Db::getInstance()->executeS('
			SELECT `id_st_easy_content`, `location`, `text_bg`, `link_color`, `link_hover`, `text_color`, `margin_top`, `margin_bottom`, `btn_color`, `btn_bg`, `btn_hover_color`, `btn_hover_bg`
			FROM `'._DB_PREFIX_.'st_easy_content` 
			WHERE `active` = 1 and (`text_bg`!="" or `text_color`!="" or `link_color`!="" or `link_hover`!="" or `margin_top`!=0 or `margin_bottom`!=0 or `btn_color`!="" or `btn_bg`!="" or `btn_hover_color`!="" or `btn_hover_bg`!="")'
        );
	}
}