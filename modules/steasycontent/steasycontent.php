...
class StEasyContent extends Module
{
    ...
    public static $location = array(
        ...
        13 => array('id' =>13 , 'name' => 'Footer primary (3/12 wide)'),
        38 => array('id' =>38 , 'name' => 'Footer primary (2/12 wide)'),
        55 => array('id' =>55 , 'name' => 'Footer primary (2.4/12 wide)'),
        39 => array('id' =>39 , 'name' => 'Footer primary (4/12 wide)'),
        40 => array('id' =>40 , 'name' => 'Footer primary (5/12 wide)'),
        41 => array('id' =>41 , 'name' => 'Footer primary (6/12 wide)'),
        71 => array('id' =>71 , 'name' => 'Footer primary (7/12 wide)'),
        72 => array('id' =>72 , 'name' => 'Footer primary (8/12 wide)'),
        73 => array('id' =>73 , 'name' => 'Footer primary (9/12 wide)'),
        74 => array('id' =>74 , 'name' => 'Footer primary (10/12 wide)'),
        42 => array('id' =>42 , 'name' => 'Footer primary (12/12 wide)'),

        3  => array('id' =>3 , 'name' => 'Footer secondary (3/12 wide)'),
        43 => array('id' =>43 , 'name' => 'Footer secondary (2/12 wide)'),
        56 => array('id' =>56 , 'name' => 'Footer secondary (2.4/12 wide)'),
        44 => array('id' =>44 , 'name' => 'Footer secondary (4/12 wide)'),
        45 => array('id' =>45 , 'name' => 'Footer secondary (5/12 wide)'),
        46 => array('id' =>46 , 'name' => 'Footer secondary (6/12 wide)'),
        81 => array('id' =>81 , 'name' => 'Footer secondary (7/12 wide)'),
        82 => array('id' =>82 , 'name' => 'Footer secondary (8/12 wide)'),
        83 => array('id' =>83 , 'name' => 'Footer secondary (9/12 wide)'),
        84 => array('id' =>84 , 'name' => 'Footer secondary (10/12 wide)'),
        47 => array('id' =>47 , 'name' => 'Footer secondary (12/12 wide)'),

        12 => array('id' =>12 , 'name' => 'Footer tertiary (3/12 wide)'),
        48 => array('id' =>48 , 'name' => 'Footer tertiary (2/12 wide)'),
        57 => array('id' =>57 , 'name' => 'Footer tertiary (2.4/12 wide)'),
        49 => array('id' =>49 , 'name' => 'Footer tertiary (4/12 wide)'),
        50 => array('id' =>50 , 'name' => 'Footer tertiary (5/12 wide)'),
        51 => array('id' =>51 , 'name' => 'Footer tertiary (6/12 wide)'),
        91 => array('id' =>91 , 'name' => 'Footer tertiary (7/12 wide)'),
        92 => array('id' =>92 , 'name' => 'Footer tertiary (8/12 wide)'),
        93 => array('id' =>93 , 'name' => 'Footer tertiary (9/12 wide)'),
        94 => array('id' =>94 , 'name' => 'Footer tertiary (10/12 wide)'),
        52 => array('id' =>52 , 'name' => 'Footer tertiary (12/12 wide)'),
        ...
        27 => array('id' =>27 , 'name' => 'Header left'),

        60 => array('id' =>60 , 'name' => 'Header top'),
        61 => array('id' =>61 , 'name' => 'Header top bottom'),
    ...
    private function _prepareHook($location)
    {
		...
		$this->smarty->assign(
            array(
                ...
                'is_full_width' => is_array($location) ? false : isset(self::$location[$location]['full_width']),
