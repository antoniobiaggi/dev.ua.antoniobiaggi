...
class CartControllerCore extends FrontController
{
    ...
    public function init()
    {
		...
		if (Tools::getValue('sizes')){
			$this->sizes = serialize(Tools::getValue('sizes'));
		}
    ...
    protected function processChangeProductInCart()
    {
        ...
        if (!$this->errors && $mode == 'add') {
            ...
            if (!$this->errors) {
                ...
                $update_quantity = $this->context->cart->updateQty($this->qty, $this->id_product, $this->id_product_attribute, $this->customization_id, Tools::getValue('op', 'up'), $this->id_address_delivery, null,true,$this->sizes);
