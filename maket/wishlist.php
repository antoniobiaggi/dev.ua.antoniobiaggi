...
<div id="wrapper">
    <link rel="stylesheet" href="<?=$link?>css/wishlist.css">
    <!--<script type="text/javascript" src="js/lookbook.js"></script>-->

    <div class="clear"></div>

    <div class="ab-wishlist-wrap">
        <div class="ab-wishlist">
            <h3>wish list</h3>


            <!--Мобильный экран-->
            <div class="ab-wishlist-table-mobile">
                <div class="ab-wishlist-table-tr">
                    <div class="ab-wishlist-table-td left">
                        <img src="<?=$link?>images/n_pages/pic11.jpg">
                    </div>
                    <div class="ab-wishlist-table-td">
                        <p class="ab-wishlist-mobile-name">Women Classic Shoes</p>
                        <p class="ab-wishlist-priceh">
                            <span class="ab-wishlist-unit-pr">Unit Price: </span><span class="price">$99,70</span>
                        </p>
                        <form method="post" class="clearfix">
                            <input type="checkbox" checked="checked">
                            <label><span>notify me about</br> price change</span></label>
                        </form>
                        <select>
                        ...
                        <p class="size-guide">size <a class="guide" href="#">guide</a></p>
                        <a class="control btn" href="#">move to basket</a>
                    </div>
                    <div class="ab-wishlist-table-td right">
                        <div class="delete"><a href="#"><img src="<?=$link?>images/n_pages/delete.png"></a></div>
                    </div>
            ...
            <div class="ab-wishlist-table-small">
                <div class="ab-wishlist-table-tr">
                    <div class="ab-wishlist-table-td left">
                        <img src="<?=$link?>images/n_pages/pic11.jpg">
                    </div>
                    <div class="ab-wishlist-table-td center">
                        <p>Women Classic Shoes</p>
                        <p>Unit Price: <span class="price">$99,70</span></p>
                        <form method="post" class="clearfix">
                            <input type="checkbox" checked="checked">
                            <label><span>notify me about</br> price change</span></label>
                        </form>
            ...
            <div class="ab-wishlist-table">
                <div class="ab-wishlist-table-tr">
                    <div class="ab-wishlist-table-th item">ITEM</div>
                    <div class="ab-wishlist-table-th desc">Description</div>
                    <div class="ab-wishlist-table-th price">UNIT PRICE</div>
                    <div class="ab-wishlist-table-th quant">QUANTITY</div>
                    <div class="ab-wishlist-table-th">size <a class="guide" href="#">guide</a></div>
                </div>
                <div class="ab-wishlist-table-tr">
                    <div class="ab-wishlist-table-td">
                        <img src="<?=$link?>images/n_pages/pic11.jpg">
                    ...
                    <div class="ab-wishlist-table-td">
                        <p>Women Classic Shoes</p>
                        <span>remove item</span>
                        <div class="ab-wishlist-table-hidden">
                            <span>QUANTITY:</span>
                            <span>2</span>
                            <a class="control minus" href="#"></a>
                    ...
                    <div class="ab-wishlist-table-td quant">
                        <span>2</span>
                        <a class="control minus" href="#"></a>
                        <a class="control plus" href="#"></a>
                    </div>
            ...
            <div class="ab-wishlist-send clearfix">
                <form method="post">
                    <button class="continue btn">CONTINUE SHOPPING</button>
                    <button class="send btn">send a list</button>
                </form>
            </div>
        </div>
        <div class="ab-wishlist-rules clearfix">
            <div class="item lt">
                <h3>wishlist rules</h3>
                <ul>
                    <li><span></span>Add the product to the wishlist does not cause the reservation.</li>
                    <li><span></span>Wishlist content is saved automatically.</li>
                    <li><span></span>Products sold are marked as "not available".</li>
                    <li><span></span>For customers logged wishlist contents stored by month.</li>
                    <li><span></span>For registered customers contents of the wishlist is stored until it is manually cleaned.</li>
                </ul>
            </div>
            <div class="item rt clearfix">
                <div class="ab-wishlist-block">
                    <h3><span><img src="<?=$link?>images/n_pages/icon_phone.png"></span>phone</h3>
                    <p>+1 (213) 550-3798 (Available
                        Monday to Friday 8am-11pm EST
                        and Saturday to Sunday
                        9am-9pm EST)</p>
                </div>
                <div class="ab-wishlist-block">
                    <h3><span><img src="<?=$link?>images/n_pages/icon_chat.png"></span>chat</h3>
                    <p>
                        Please note that whilst
                        we will always try to have
                        an agent available, we may
                        not be free during peak
                        service times.
                    </p>
                </div>
                <div class="ab-wishlist-block">
                    <h3><span><img src="<?=$link?>images/n_pages/icon_email.png"></span>email</h3>
        ...
        <div class="ab-wishlist-recently-viewed clearfix">
            ...
            <div class="recently-viewed-gallery clearfix">
                <div class="item">
                    <img src="<?=$link?>images/n_pages/pic12.jpg">
                    <h3>Women Leather Shoes</h3>
                    <p><span><strike>$560</strike></span>$480</p>
                </div>
                <div class="item">
                    <img src="<?=$link?>images/n_pages/pic13.jpg">
                    <h3>Women Leather Shoes</h3>
                    <p><span><strike>$560</strike></span>$480</p>
                </div>
                <div class="item">
                    <img src="<?=$link?>images/n_pages/pic14.jpg">
                    <h3>Women Leather Shoes</h3>
                    <p>$560</p>
                </div>
                <div class="item">
                    <img src="<?=$link?>images/n_pages/pic15.jpg">
                    <h3>Women Leather Shoes</h3>
                    <p>$560</p>
                </div>
            </div>
