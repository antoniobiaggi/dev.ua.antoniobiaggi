...
<div id="wrapper">
    <link rel="stylesheet" href="<?=$link?>css/sale.css">
    <!--<script type="text/javascript" src="js/lookbook.js"></script>-->

    <div class="clear"></div>

    <div class="ab-sale-wrap">
        <div class="ab-sale">
            <h3>Sale</h3>

            <div class="ab-sale-image clearfix">
                <div class="ab-sale-image-side lt">
                    <div class=" banner banner-left">
                        <h3>15<span>%</span></h3>
                        <p>First Choice </br><span>Discount.</span></p>
                        <span>* Limited OFFER</span>
                    </div>
                    <div class=" banner banner-right">
                        <h3>40<span>%</span></h3>
                        <p>Huge Autumn </br><span>Sale.</span></p>
                        <span>* until 19 of january</span>
                    </div>
                </div>
                <div class="ab-sale-image-side rt">
                    <div class="banner banner-big">
                        <h3>60<span>%</span></h3>
                        <p>Happy New Year </br><span>Sale.</span></p>
                        <span>* until 10th of january</span>
                        <img class="banner-big-image" src="<?=$link?>images/n_pages/ban1.png">
                    </div>
                </div>
