		...
		<div class="col-lg-12">
			<div class="form-group">
				<div class="col-lg-1">
					<span class="pull-right">
						{if isset($display_multishop_checkboxes) && $display_multishop_checkboxes}
							...
							{include file="controllers/products/multishop/checkbox.tpl" only_checkbox="true" field="main_prod" type="default"}
						{/if}
					</span>
				</div>
				...
				<div class="col-lg-9">
					<div class="checkbox">
						<label for="main_prod">
							<input type="checkbox" name="main_prod" id="main_prod" value="1" {if $product->main_prod}checked="checked"{/if} >
							{l s='main_prod'}</label>
					</div> 
					<div class="checkbox">
